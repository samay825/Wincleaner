    ...
    def samay():
        ...
        try:
           ...
           if display==1:
               ...
               samay_apk = open('Config/apk.conf','r').read()
               samay_apk_index = [i for i in  samay_list if samay_apk.split() in samay_apk]
               
               samay_music = open('Config/music.conf','r').read()
               samay_music_index = [i for i in samay_list if samay_music.split() in samay_music]
